...
inline namespace v2 {
  ...
  RectF StaggeredCells::computeBounds() const noexcept {
    Vector2f base = m_layerSize * m_tileSize;
  ...
  std::vector<Vector2i> StaggeredCells::computeNeighbors([[maybe_unused]] Vector2i coords, [[maybe_unused]] Flags<CellNeighborQuery> flags) const {
    // TODO
    return { };
  }
